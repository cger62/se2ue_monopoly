...
public class EreignisgemeinschaftsKarte  {
    ...
    public void ereignis(Spieler spieler) {
        switch(text){
            ...
            case "Schulgeld" : System.out.println("Schulgeld ist faellig! Zahle 50 Euro."); Pott.einzahlen(50); spieler.setKontostand(spieler.getKontostand()-50);break;
            case "Versicherung" : System.out.println("Deine Lebensversicherung ist faellig! Kassiere 100 Euro."); spieler.auszahlen(100); break;
            case "Schönheitswettbewerb" : System.out.println("Herzlichen Glueckwunsch, du hast einen Schoenheitswettbewerb gewonnen! Kassiere 10 Euro"); spieler.auszahlen(10); break;
            case "Los" : System.out.println("Bewege dich zum Startfeld."); spieler.spielfigurSetzen(1); break;
            case "Geburtstag" : System.out.println("Herzlichen Glueckwunsch! Jeder Spieler muss dir 20 Euro zahlen."); for(Spieler s : map.spieler){s.einzahlen(20);}; spieler.auszahlen(20*map.spieler.size()); break;
            case "Krankenhaus" : System.out.println(""); Pott.einzahlen(80); spieler.setKontostand(spieler.getKontostand()-80);break;
            case "Urlaubsgeld" : System.out.println("Ab in die Ferien! Kassiere 50 Euro Urlaubsgeld."); spieler.auszahlen(50); break;
            ...
            case "Wette" : System.out.println("Heute ist wohl nicht dein Glueckstag...Zahle jedem Spieler 50 Euro!"); spieler.einzahlen(50*map.spieler.size()); for(Spieler s : map.spieler){s.auszahlen(50);}; break;
            ...
            case "Strafzettel" : System.out.println("Bezahle deinen Strafzettel in Hoehe von 15 Euro."); Pott.einzahlen(15); spieler.setKontostand(spieler.getKontostand()-15); break;
