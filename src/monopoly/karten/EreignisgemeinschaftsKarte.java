...
public class EreignisgemeinschaftsKarte  {
    ...
    public void ereignis(Spieler spieler) {
        switch(text){
            ...
            case "Geburtstag" : System.out.println("Herzlichen Glueckwunsch! Jeder Spieler muss dir 20 Euro zahlen."); for(Spieler s : map.spieler){s.einzahlen(20);}; spieler.auszahlen(20*(map.spieler.size()+1)); break;
