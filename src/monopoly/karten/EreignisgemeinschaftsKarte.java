...
public class EreignisgemeinschaftsKarte  {
    ...
    public void ereignis(Spieler spieler) {
        switch(text){
            ...
            case "Geburtstag" : System.out.println("Herzlichen Glueckwunsch! Jeder Spieler muss dir 200 Euro zahlen."); for(Spieler s : map.spieler){s.einzahlen(200);}; spieler.auszahlen(200*(map.spieler.size())); break;
